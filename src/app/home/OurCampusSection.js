...
const OurCampusSection = () => {
  ...
  useEffect(() => {
    ...
    const initVideoAnimation = () => {
      ...
      minW = video.parentElement
        ? video.parentElement.offsetWidth * 0.65
  ...
  return (
    <div
      ref={sectionRef}
      className="relative w-full flex flex-col items-center justify-center min-h-screen h-screen overflow-hidden magnet-section bg-gradient-to-br from-[#085038] to-[#02BA89] mob-height-adjust"
    >
      <div className="relative flex flex-col items-center justify-center w-full max-w-[1920px] z-10 px-4 mt-0 pt-4 gap-0 md:gap-0 h-full">
        ...
        <p
          ref={campusDescRef}
          className="font-[Gideon_Roman] font-normal text-[24px] leading-[44px] text-center text-white mt-[-20px] mb-0 px-4 max-w-7/10 mx-auto capitalize tracking-normal ourCampusContent"
          style={{
            letterSpacing: 0,
        ...
        >
          At Western, Our Campus Provides A Nurturing Environment With Modern Classrooms, Fully
          Equipped Labs, And A Resource-Rich Library. Spacious Outdoor Areas Encourage Physical
          Activity, While The Safe, Well-Maintained Surroundings Ensure Students Thrive Academically
          And Socially.
        </p>
      </div>
    </div>
