  ...
  return (
    <div className="relative w-full min-h-screen h-screen flex flex-col items-center justify-start pt-16 md:pt-24 overflow-hidden bg-[#074D36] magnet-section">
      ...
      >
        ...
        >
          Nestled on a sprawling 20-acre eco-friendly campus on the outskirts of Kerala’s capital,
          Western International School blends natural beauty with cutting-edge infrastructure.
          Designed to inspire holistic development, the campus provides an enriching environment
          where students excel academically, creatively, and personally.
        </p>
